...
ColorPositionDown = [2,1,0]#下台阶颜色位置
...
def GetColorPositionDown():
    ...
    for i in range(3):
        #如果BlobStatr[i]不存在
        # print("Current Check Color is:",i)
        if BlobStateDown[i] == 0:
            ColorPositionDown[i]=3
            # print("Color Code Not Found ?")
        elif BlobStateDown[i][0].cx()<=FTH01:
