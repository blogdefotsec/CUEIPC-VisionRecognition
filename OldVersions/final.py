...
red = (56, 70, 6, 127, -2, 30)#(9, 51, 23, 96, -10, 81)#(14, 40, 18, 52, 1, 127)
green = (62, 71, -33, -10, 11, 20)#(0, 51, -96, -14, -19, 54)
...
def ColorThresholds():
    ...
    while True:
        ...
        for i in range(3):
            #flag = 0
            blobs = img.find_blobs(color_thresholds[i],pixels_threshold = pixels_threshold,area_threshold = area_threshold,merge = True,roi=roiFF)
            if blobs:
                for b in blobs:
                    if i==0:
